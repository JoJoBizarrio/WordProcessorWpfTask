...
namespace WordProcessorWpfTask.Tests
{
    ...
    public class ViewModelTests
    {
        ...
        //{
        //    _redactorMock.Setup(redactor => redactor.OpenFile(string.Empty).Result).Returns(new TextFile() { Text = "test" }).Verifiable();

        //    _viewModel.Open.ExecuteAsync(string.Empty);
        ...
        //    _viewModel.Save.ExecuteAsync(string.Empty);
